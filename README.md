...
1. Click **Fork** at the top of this repository. Create the fork in your student GitHub account.
...
Drafts save in your Codespace. GitHub checkpoints commit and push your current answers and evidence to your fork. Changed evidence creates a new checkpoint. Failed attempts can also be sent for review. Completion is separate from GitHub delivery and instructor review of your reasoning.

The investigations teach initial control authority, signed moment budgets, derivative units, travel, local-flow assumptions, validity, testing, actuator timing and bounded decisions. They do not establish successful takeoff, crosswind approval or aircraft safety.

[Detailed student and instructor guide](docs/ONBOARDING-CLASSROOM.md) · [Chapter 6 mission map](docs/CHAPTER06-GAME-MAP.md)
